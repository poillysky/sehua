  ...
  useEffect(() => {
    void fetchSettings()
      .then((s) => {
        ...
        setFlareUrl(s.flaresolverr_url || '')
          ...
          <div className="settings-card-body">
            <div className="settings-form-fields">
              ...
              <label className="settings-field-full">
                FlareSolverr（可选）
                <input
                  placeholder="可空；例 http://127.0.0.1:8191/v1"
                  value={flareUrl}
                  disabled={loading}
            ...
            <p className="hint">
              代理供联通探测与 HTTP 读帖。FlareSolverr 可空：未填时遇 Cloudflare 走浏览器等待，并尝试本机自动探测；填了则优先用该地址过
              Turnstile 并写入 cookie。请求延迟 / 冷却见论坛「爬虫配置」。
            </p>
