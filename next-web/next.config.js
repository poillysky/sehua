...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // 已撤出影视区的旧板 → 影视区首页（107 三级/写真需可浏览，勿重定向）
      { source: "/b/103", destination: "/c/2", permanent: false },
      { source: "/b/103/:path*", destination: "/c/2", permanent: false },
      { source: "/b/39", destination: "/c/2", permanent: false },
      { source: "/b/39/:path*", destination: "/c/2", permanent: false },
      { source: "/b/151", destination: "/c/2", permanent: false },
      { source: "/b/151/:path*", destination: "/c/2", permanent: false },
      { source: "/b/160", destination: "/c/2", permanent: false },
      { source: "/b/160/:path*", destination: "/c/2", permanent: false },
    ];
  },
  async rewrites() {
    const scrapeOrigin = (
