...
export const TranslateIcon = (props: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const Ed2kLogo: React.FC<IconSvgProps> = ({
  size,
  width,
  height,
  className,
  ...
  >
    ...
    />
    <path
      d="M28 27h44v8H36v10h28v8H36v12h36v8H28V27z"
      fill="currentColor"
    />
  </svg>
);

/** @deprecated 使用 Ed2kLogo */
export const MagnetIcon = Ed2kLogo;
