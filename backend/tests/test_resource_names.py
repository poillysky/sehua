...
def test_missing_placeholder_magnet():
    ...
    assert is_missing_filename("ABCDEFabcdefABCDEF0123456789ABCDEF01234567", hash_value="ABCDEFabcdefABCDEF0123456789ABCDEF01234567")
...
def test_persist_multi_and_single_naming(monkeypatch):
    ...
    assert calls[0]["filename"] == "子文件A.mp4"
    ...
    assert calls[0]["filename"] == "alone.mp4"  # 有名保留
