...
_PATTERNS: list[tuple[str, str]] = [
    ...
    ("ssl", "安全证书校验失败，请检查代理或站点证书"),
    ("certificate", "安全证书校验失败，请检查代理或站点证书"),
    ("proxy", "代理连不上，请检查代理地址是否可用"),
    ("request failed", "请求失败，请检查网络或代理后重试"),
    ("connecterror", "网络连接失败，请检查网络或代理后重试"),
    ("拒绝回落主库", "独立资源库连不上，已停止操作以免写错库。请到「数据管理」检查资源库设置"),
    ("独立资源库不可用", "独立资源库连不上，请到「数据管理」检查连接或暂时关闭独立资源库"),
    ("conflict", "当前有其他任务在进行，请稍后再试"),
]
