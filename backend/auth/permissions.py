...
ROUTE_PERMISSIONS: dict[tuple[str, str], str] = {
    ...
    ("POST", "/api/system/reset-crawl"): "settings.write",
    ("POST", "/api/system/reset-resources"): "settings.write",
    ...
    ("GET", "/api/crawler/queue/frame-fail/tids"): "crawler.view",
    ("POST", "/api/crawler/queue/discarded/requeue"): "crawl.run",
    ("POST", "/api/crawler/queue/discarded/requeue-tids"): "crawl.run",
    ("POST", "/api/crawler/queue/frame-fail/recrawl-tids"): "crawl.run",
