...
[![Version](https://img.shields.io/badge/version-1.2.5-0ea5e9?style=flat-square)](./VERSION)
...
| 产品 | 标签 |
|------|------|
| sehua | [`1.2.5`](https://hub.docker.com/r/poillysky/sehuatang-app/tags)（见 `deploy/docker-compose.nas.yml`） |
...
```text
ghcr.io/poillysky/sehuatang-app:1.2.5
