...
[![Version](https://img.shields.io/badge/version-1.2.24-0ea5e9?style=flat-square)](./VERSION)
...
| search | [`1.2.6`](https://hub.docker.com/r/poillysky/sehuatang-search/tags)（见 `deploy/docker-compose.search.yml`；含 scrape） |
...
ghcr.io/poillysky/sehuatang-search:1.2.6
```
