...
[![Version](https://img.shields.io/badge/version-1.2.19-0ea5e9?style=flat-square)](./VERSION)
...
| 产品 | 标签 |
|------|------|
| sehua | [`1.2.19`](https://hub.docker.com/r/poillysky/sehuatang-app/tags)（见 `deploy/docker-compose.nas.yml`） |
| search | [`1.2.1`](https://hub.docker.com/r/poillysky/sehuatang-search/tags)（见 `deploy/docker-compose.search.yml`） |
...
```text
ghcr.io/poillysky/sehuatang-app:1.2.19
ghcr.io/poillysky/sehuatang-search:1.2.1
```
